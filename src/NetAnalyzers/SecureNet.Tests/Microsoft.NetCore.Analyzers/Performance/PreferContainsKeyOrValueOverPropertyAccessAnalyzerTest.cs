...
using VerifyCS = Test.Utilities.CSharpCodeFixVerifier<
    SecureNet.Category.Performance.PreferContainsKeyOrValueOverPropertyAccessAnalyzer,
    SecureNet.Category.Performance.PreferContainsKeyOrValueOverPropertyAccessFixer>;
